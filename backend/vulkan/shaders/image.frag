...
layout(set = 0, binding = 0) uniform texture2D image_tex_t;
layout(set = 0, binding = 1) uniform sampler image_tex_s;
#define image_tex sampler2D(image_tex_t, image_tex_s)
